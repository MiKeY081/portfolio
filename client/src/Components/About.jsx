      ...
      <AnimatePresence>
        ...
        >
          <div>
            ...
            <p className="mb-4">
              In my academic journey, I've gained skills in frontend
              technologies such as React, Next.js, HTML, CSS, and Tailwind. On
              the backend, I'm familiar with Mongoose, Prisma, MongoDB, and
              Node.js.
            </p>
            <p className="mb-4">
              While I don't have specific passions, I aspire to contribute to my
              nation and the human existence through the skills I am acquiring.
              My hobbies include exploring the realms of cybersecurity and web
              development. I'm also a chess enthusiast.
            </p>
            <p className="mb-4">
              I draw inspiration from the divine and aim to live my life to the
              fullest. My philosophy is to [you can add your own philosophy
              here].
            </p>
            <p>
              Let's connect and explore the infinite possibilities that
              technology offers to make a positive impact on the world!
            </p>
          </div>
        </motion.div>
      </AnimatePresence>
