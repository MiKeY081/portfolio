...
const AboutMe = () => {
  return (
    <div className={`about bg-black min-h-screen pt-16 pb-16 px-8 sm:px-16 lg:px-20 rounded-md shadow-md overflow-hidden`}>
      <h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold mb-8 text-center">About Me</h2>
      <div className="flex flex-col lg:flex-row items-center">
        ...
        >
          <img
            ...
            alt=""
            className="relative w-full max-w-xs md:max-w-md lg:max-w-full rounded-full"
          />
        </motion.div>
        <motion.div
